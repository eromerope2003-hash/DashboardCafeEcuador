...
- **Key confirmed facts (higher confidence, cross-checked across multiple sources):**
  ...
  - Japan: Ecuador has **no EPA/FTA with Japan**, but a 2026-08-04 follow-up pass found Japan's own customs authority (customs.go.jp) lists roasted coffee (0901.21) at **12% WTO-bound rate / 10% GSP preferential rate** — this replaces the earlier ~20% JETRO-derived estimate, which appears to have been imprecise. Ecuador was also separately confirmed as one of Japan's ~126 GSP (Generalized System of Preferences) beneficiary developing countries (Japan MOFA), which is a real, distinct-from-EPA channel that could lower Ecuador's effective roasted-coffee tariff to 10% — **but whether roasted coffee is specifically on Japan's ~431-item GSP agricultural product list was not confirmed**, so treat 10% as likely-but-unverified and 12% as the safe worst case.
  - Chile: a 2026-08-04 follow-up pass confirmed directly via Chile's own customs authority (Servicio Nacional de Aduanas, aduana.cl) that the 6% general ad valorem tariff is the standard rate Chile applies on the CIF value of imports from countries without a trade agreement — this upgrades the confidence of the 6% MFN figure from a pure inference to an official-source-confirmed general policy (the exact HS 0901 line-item text itself still wasn't pulled verbatim, so this is not a 100% primary citation, but materially stronger than before).
- **Explicit gaps/genuinely uncertain cells (do not present these as confirmed in the report without further verification):**
  - Korea's exact MFN rates for roasted coffee (0901.21) and coffee extract (210111) were not found, despite a second targeted search pass on 2026-08-04.
  - China's exact MFN rate for coffee extract (210111) was not found (re-checked 2026-08-04, still unresolved); China's own 5–20% "pre-FTA" range (from press coverage) does not fully reconcile with the 8%/15% green/roasted figures found via a Costa Rican government secondary source — genuine ambiguity, not resolved here.
  - Japan's 210111 (instant coffee extract) exact rate was still not found even after the 2026-08-04 follow-up pass (only that Japan classifies 2101.11-100/210/2101.12 as distinct subheadings, and that Japan's GSP scheme may cover it — not confirmed).
